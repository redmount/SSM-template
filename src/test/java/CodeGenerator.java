...
//        tombstonedTableMap.put("test_teacher", true);
    ...
    public static void genModelAndMapper(String tableName, String modelName, boolean isTombstoned) {
        ...
        pluginConfiguration.setConfigurationType(ModelCommentGenerator.class.getCanonicalName());
...
//            tableConfiguration.addProperty("useActualColumnNames", "true");
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            File file = new File(PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_SERVICE + modelNameUpperCamel + "BaseService.java");
